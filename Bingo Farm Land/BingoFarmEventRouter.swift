...
class BingoFarmWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (BingoFarmWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (BingoFarmWebStatus) -> Void) {
