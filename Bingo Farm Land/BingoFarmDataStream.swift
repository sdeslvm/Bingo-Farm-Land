...
final class BingoFarmBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: BingoFarmWebLoader
    private let coordinator: BingoFarmWebCoordinator
    ...
    init(
        ...
        loader: BingoFarmWebLoader,
        coordinator: BingoFarmWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        BingoFarmOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        BingoFarmOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        BingoFarmOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension BingoFarmBaseWebViewController {
